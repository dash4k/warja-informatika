...
<div class="container py-4 max-w-lg mx-auto">
    <h1 class="mb-4 text-2xl font-bold">Tambah Jurnal</h1>
    <form action="{{ route('admin.jurnal.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="penulis" class="w-full border rounded px-3 py-2" required value="{{ old('penulis') }}">
        </div>
        <div class="mb-3">
            <label class="block mb-1 font-semibold">Jalur</label>
            <input type="text" name="jalur" class="w-full border rounded px-3 py-2" required value="{{ old('jalur') }}">
        </div>
        <div class="mb-3">
            <label class="block mb-1 font-semibold">Tahun</label>
            <input type="text" name="tahun" class="w-full border rounded px-3 py-2" required value="{{ old('tahun') }}">
        </div>
        <div class="mb-3">
            <label class="block mb-1 font-semibold">Link (opsional)</label>
            <input type="text" name="link" class="w-full border rounded px-3 py-2" value="{{ old('link') }}">
        </div>
