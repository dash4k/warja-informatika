            ...
            <section class="rounded-t-2xl p-4 bg-white w-full h-fit border-x-2 border-b-2 border-t-3 border-lightGray flex flex-col gap-2">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="pancasila" id="pancasila" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="pendidikanAgama" id="pendidikanAgama" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="matematikaDiskrit2" id="matematikaDiskrit2" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">    
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="pengantarProbabilitas" id="pengantarProbabilitas" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="kewirausahaan" id="kewirausahaan" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="tataTulisKaryaIlmiah" id="tataTulisKaryaIlmiah" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="strukturData" id="strukturData" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="sistemOperasi" id="sistemOperasi" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/3">
                        ...
                        <input name="organisasiArsitekturKomputer" id="organisasiArsitekturKomputer" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400" placeholder="80.00">
