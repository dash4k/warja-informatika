    ...
    <section action="" method="post" class="lg:right-[2.7%] mt-25 lg:ml-[20%] lg:mt-20 lg:w-7/9 min-h-screen w-5/6 max-w-[86%] mx-auto rounded-sm mainMainContentDashboard transition-all duration-300 flex flex-col gap-5" enctype="multipart/form-data">
        ...
        <form method="post" action="{{ route('nilai', ['semester' => 1]) }}">
            ...
            <section class="rounded-t-2xl p-4 bg-white w-full h-fit border-x-2 border-b-2 border-t-3 border-lightGray flex flex-col gap-2">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="etikaProfesi" id="etikaProfesi" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="kewarganegaraan" id="kewarganegaraan" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">    
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="bahasaIndonesia" id="bahasaIndonesia" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="matematikaDiskrit_1" id="matematikaDiskrit1" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="statistikaDasar" id="statistikaDasar" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="algoritmaPemrograman" id="algoritmaPemrograman" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="sistemDigital" id="sistemDigital" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="matematikaInformatika" id="matematikaInformatika" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
            ...
            <div class="px-4 rounded-b-2xl bg-white w-full h-auto border-x-2 border-b-2 border-lightGray flex flex-col lg:flex-row  items-center justify-center lg:justify-end gap-1 lg:gap-2">
                <div class="w-full lg:w-1/4 lg:h-28 flex flex-col lg:flex-row gap-2 pt-4 pb-4 lg:pb-0 lg:justify-center lg:items-center lg:pt-0 font-roboto">
