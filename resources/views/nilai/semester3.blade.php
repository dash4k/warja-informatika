            ...
            <section class="rounded-t-2xl p-4 bg-white w-full h-fit border-x-2 border-b-2 border-t-3 border-lightGray flex flex-col gap-2">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="interaksiManusiaKomputer" id="interaksiManusiaKomputer" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="basisData" id="basisData" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">    
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="desainAnalisisAlgoritma" id="desainAnalisisAlgoritma" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="rekayasaPerangkatLunak" id="rekayasaPerangkatLunak" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center lg:items-end justify-between gap-2">
                    ...
                    <div class="w-full lg:w-1/2">
                        ...
                        <input name="komunikasiDataJaringanKomputer" id="komunikasiDataJaringanKomputer" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
                ...
                <div class="w-full flex flex-col lg:flex-row items-center justify-between gap-2">
                    ...
                    <div class="w-full lg:w-full">
                        ...
                        <input name="teoriBahasaOtomata" id="teoriBahasaOtomata" type="number" step="0.01" class="bg-lightGray w-full text-darkGray py-2 pl-1 px-2 text-sm placeholder:text-gray-400 rounded-md" placeholder="80.00">
