...
<nav class="sticky z-100 top-0 left-0 w-auto border-b-2 p-5 border-lightGray bg-paperWhite">
    ...
    <!-- Logo -->
        ...
        <div class="hidden md:flex ml-11 gap-2 space-x-3 font-poppins font-medium bg-white/60 backdrop-blur-md backdrop-saturate-150 border-b border-white/30 z-50 text-sm">
            <a href="{{ url('/deskripsi-jalur') }}" class="hover:text-darkBlue pt-1 pb-1 text-black p-1 px-4">
                Deskripsi
            </a>
            <a href="{{ url('/statistik') }}" class="hover:text-darkBlue pt-1 pb-1 text-black p-1 px-4">
                Statistik
            </a>
            <a href="{{ url('/refrensi') }}" class="hover:text-darkBlue pt-1 pb-1 text-black p-1 px-4">
                Referensi
            </a>
        </div>
        <!-- Penjaluran Button -->
...
<div class="hidden fixed z-[100] top-[64px] left-0 w-full px-4 pt-4 pb-4 space-y-2 bg-white shadow-md flex flex-col justify-center items-center" id="hamburgerMenu">
    <a href="/deskripsi-jalur" class="block hover:text-darkBlue pt-1 pb-1 text-black p-1 px-1">
        Deskripsi
    </a>
    <a href="/statistik" class="block hover:text-darkBlue pt-1 pb-1 text-black p-1 px-1">
        Statistik
    </a>
    <a href="/refrensi" class="block hover:text-darkBlue pt-1 pb-1 text-black p-1 px-1">
        Referensi
    </a>
